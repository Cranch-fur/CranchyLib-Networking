...
namespace CranchyLib.Networking
{
    public static class Main
    {
        ...
        public static class Networking
        {
            ...
            public static class SE_ContentType
            {
            ...
            public static class SE_UserAgent
            {
                ...
                public static Tuple<bool, string> Download(string url, string dest)
                {
                    ...
                    try
                    {
                        using (HttpWebResponse response = (HttpWebResponse)request.GetResponseAsync().Result)
                        {
                            ...
                            else return Tuple.Create(false, "[X] Requested File can't be found on PC");
                        }

                    }
                    catch (Exception e)
                    {
                        return Tuple.Create(false, $"[X] Exception: {e.Message}");
                    }
                }
